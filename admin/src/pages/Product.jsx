      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="flex-1 bg-white p-5 shadow-lg rounded-lg">
          <div className="flex items-center mb-5">
            <img
              src="https://image.pexels.com/photos/8054395/pexels-photo-8054395.jpeg"
              alt=""
        ...
        <form action="" className="flex flex-col md:flex-row gap-5">
          ...
          <div className="flex-1 space-y-5">
              <div>
                ...
                <input type="text" className="w-full p-2 border border-gray-200 rounded" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="number" className="w-full p-2 border border-gray-200 rounded" />
              </div>
              <div>
              ...
              <div>
                <label htmlFor="" className="block mb-2 font-semibold">InStock</label>
                <select name="" id="" className="w-full p-2 border border-gray-200 rounded">
