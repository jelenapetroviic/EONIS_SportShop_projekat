      ...
      <div className="mr-[50px]">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 pb-4">
            <img src="https://image.pexels.com/photos/8054395/pexels-photo-8054395.jpeg" alt="" 
              className="w-32 h-32 object-cover rounded-md"
            />

            <div className="flex-1 ml-4">
              <h3 className="text-xl font-semibold mb-2">Radiate Beauty, Inside and Out </h3>
              <p className="text-gray-600 mb-2">Discover Your Perfect Product for a Flawless Look.</p>
